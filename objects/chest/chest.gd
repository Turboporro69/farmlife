...
var balloon_scene = preload("res://dialogue/game_dialogue_balloon_chest.tscn")

var corn_harvest_scene = preload("res://objects/corn_harvest.tscn")
var tomato_harvest_scene = preload("res://objects/tomato_harvest.tscn")
